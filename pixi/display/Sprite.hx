...
class Sprite extends DisplayObjectContainer {
	...
	public var blendMode:pixi.BlendModes;
	...
	private var onTextureUpdateBind:Dynamic;
 ...
 * @private
 */
private function onTextureUpdate (event:Dynamic)
{
 ...
 */
public static function fromImage (imageId)
{
