...
public static function multiply (mat, mat2, dest) 
{
...
public static function clone (mat)
{
	var matrix = new Matrix(9);
...
public static function transpose (mat, dest) 
{
...
public static function toMat4 (mat, dest) 
{
