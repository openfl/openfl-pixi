 ...
 * @private
 */
private function collectInteractiveSprite (displayObject:DisplayObjectContainer, iParent:DisplayObjectContainer)
{
 ...
 * @private
 */
public function setTarget (target:Dynamic)
{
 ...
 * @private
 */
private function onTouchMove (event)
{
	var rect = this.target.view.getBoundingClientRect();
 ...
 * @private
 */
private function onTouchEnd (event)
{
 ...
 */
public function getLocalPosition (displayObject)
{
