 ...
 */
public static function renderGraphics (graphics:Graphics, context:CanvasRenderingContext2D)
{
 ...
 * @param context {Context2D}
 */
public static function renderGraphicsMask (graphics:Graphics, context:CanvasRenderingContext2D)
{
	var worldAlpha = graphics.worldAlpha;
