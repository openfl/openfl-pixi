...
public function new (width:Float = 800, height:Float = 600, view:Dynamic = null, transparent:Bool = false)
{
 ...
 * @private
 */
private function renderDisplayObject (displayObject:DisplayObject)
{
	// no loger recurrsive!
	var transform;
 ...
 * @private
 */
private function renderStripFlat (strip:Strip)
{
	var context = this.context;
 ...
 * @private
 */
private function renderTilingSprite (sprite:TilingSprite)
{
	var context = this.context;
 ...
 * @private
 */
private function renderStrip (strip:Strip)
{
	var context = this.context;
